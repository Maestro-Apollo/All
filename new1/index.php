...
//         // if($newsletter != "")
//         // {
//         //     echo "1news". $newsletter;
//     //   echo "hello1". $newsletter;
//     //         echo "hello188". $newsletter == null;
//     //         echo "hello1009". $newsletter != null;
            ...
            <div class="modal-body">
                ...
                <div class="rt-modal-input one">
                    ...
                    <div class="ac-register rt-mb-40">
                        <span>Don’t have an account? <a href="welcome.php" >Sign Up Now <i class="icofont-double-right"></i></a></span>
                    </div><!-- /.ac-register -->
                </div><!-- /.rt-modal-input -->
            ...
            <div class="row rt-banner-height align-items-center">
                <div class="col-lg-9">
                    ...
                    <div class="rt-banner-content">
                        ...
                        We use the latest technology combined with our advanced expertise to find first and business
            ...
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <img src="Images/Artboard–12.png" alt="counter_iocn" draggable="false">
                    <div class="media-body">
                        ...
                        <h6><span class="counter">5000</span><span>+</span></h6>
                    </div>
                </div>
            </div><!-- /.col-lg-4 -->
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mx-auto text-center">
                <div class="services-box-1 wow fade-in-bottom how-it-works-section">
                    ...
                    <p>We don’t do contracts or sign-up fees. Once you are registered, you can book all your flight management to CorporateBusinesClass.</p>
                </div><!-- /.services-box-1 -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 col-md-6 mx-auto text-center">
                <div class="services-box-1 wow fade-in-bottom how-it-works-section" data-wow-duration="1.5s">
                    ...
                    <p>Our 3 main focus areas are Speed, Quality , and Cost. Depending on what your organization values more, we will adjust accordingly. </p>
                </div><!-- /.services-box-1 -->
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4 col-md-6 mx-auto text-center">
                <div class="services-box-1 wow fade-in-bottom how-it-works-section" data-wow-duration="2s">
                    ...
                    <p>Our team of experts are the best in the industry and along side with the latest technology, we are able to get you better flights, for less time and money</p>
                </div><!-- /.services-box-1 -->
            </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
                                ...
                                <div class="display-inline">
                                 ...
                                 <div class="display-inline">
                                    ...
                                    <div>
                                        ...
                                        <p>Experts around different time zones are ready to assist you in real-time 24/7</p>
                                    </div>
                                </div>
                                 <div class="display-inline">
                                    <div class="w-110">
                                    ...
                                    <div>
                                        ...
                                        <p>We use miles and upgrades to maximise your savings without compromising comfort</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="display-inline">
                                    ...
                                    <div>
                                        ...
                                        <p>The best way to book is different each time, we use the latest technology to get you on the best flight and the least amount of cost</p>
                                    </div>
                                </div>
                                 <div class="display-inline">
                                    <div class="w-110">
                                    ...
                                    <div>
                                        ...
                                        <p>We are an email or call away to help you with any changes or amendments you might need.</p>
                                    </div>
                                </div>
                                 <div class="display-inline">
                                    <div class="w-110">
                                    ...
                                    <div>
                                        ...
                                        <p>We are on the cloud and can help you in whichever communication method you prefer.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
...
<!-- 
 ...
 <div class="play-video rtbgprefix-full bg-hide-md video-section-4 h-350" style="background-image: url(Images/Artboard–14.png); height: 700px;background-size: auto;background-repeat-x: repeat;">
</div>
                    ...
                    <div class="text-center mx-auto text-white">
                            <div class="rt-section-title-wrapper">
                                <h5 class="rt-section-title">
                                    ...
                                    New Standard in Corporate Travel
                                </h3><!-- /.rt-section-title -->
                                <!-- <p>Our thoughtful team of knowledgeable experts are here to take care of every need,
                                    from the second you contact us to when you return</p> -->
                            </div><!-- /.rt-section-title-wrapper- -->
                    ...
                    <!-- <h2 class="rt-section-title">
                        ...
                        <div class="text-center mt-5">
                                <span class="d-md-inline d-none">
                                    <a href="welcome.php" class="rt-btn rt-rounded rt-rounded-1 rt-Bshadow-1 btn-blue2">Join for Free</a>
                    ...
                    <div class="testimoninal-active-1">
                        <div class="row">
                            ...
                            <div class="col-lg-6 rt-pr-200">
                                <p class="f-size-14 rt-pb-20 rt-mt-60">I joined because I needed a reliable team to manage my teams travel overseas. I could not be happier as they constantly find me better flights for less. When I reach out for a flight, I can say  without reservation that I am taken care of. Every quarter they provide me with financials which tell me what I have spent and how much I saved on travel. I highly recommend them.</p>
                                <p class="f-size-15 rt-mb-0"><strong class="text-blue1">Ramon Van Meer</strong></p>
                                <p class="f-size-13 l-spacing-4"><strong class="text-blue1">CEO - VanMeer Capital</strong></p>
                            </div>
                        </div>
    ...
    <section class="rt-cta-area mt-200 video-section-3 manifesto-section pos-rel">
            ...
            <div class="container">
                <div class="text-center text-white rt-mb-40">
                    <h3><strong>Will I save Money?</strong></h3>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="rt-pt-70 rt-pb-60 rt-pl-80 rt-pr-80 rt-ml-60 rt-mr-60" style="background-color: #ffffff; border-radius: 10px;box-shadow: 0 5px 10px 0 rgba(55, 94, 246, .2);">
                            ...
                            <div>
                                <p>You don’t become an expert in luxury travel if you can’t be transparent with the fees and deliver
                                the value you deserve. The world of corporate travel may be complex, but we demystify it for
                                you, leaving you only with opportunity.
                                </p>
                                <p>The world of business travel is full of perks for frequent flyers that range from airline miles and
                                credit card rewards, to emergency support on the ground and private lounge access; you should
                                expect your corporate travel manager to deliver these perks, and yet most don’t.</p>
                                <p>But Corporate Business Class does. No other corporate travel manager guarantees you greater
                                savings over retail than we can.</p>
                                <p>Typical corporate managers rely on hidden industry commissions; Kayak may have a better
                                price for an itinerary, but since they don’t pay commissions, the corporate manager won’t offer it
                                to you. Instead you are stuck with a higher priced itinerary so the manager can collect the
                                hidden commissions.</p>
                                <p>And this extends to the perks. If a travel manager can’t collect commissions on loyalty
                                programs, elite status or any other perks, you won’t receive them.</p>
                                <p>With Corporate Business Class, you get everything you deserve and more!</p>
                                <p>Maintain the elite business status you have worked hard to earn.</p>
                                <p>Corporate Business Class… The only way to book your business travel.</p>
                ...
                <div class="row">
                    <div class="col-lg-7 mx-auto">
                         <div class="input-group mb-5">
                            <div class="w-100">
                                <input type="email" class="form-control text-white f-size-14" name="newsletter1" id="newsletter1" placeholder="Enter your email">
                            </div>
                            <!-- <span class="text-danger"> <?php echo $newsletterErr;?></span> -->
                            <div class="input-group-append">
                                <input class="btn" type="button" name="newsletterIndex" id="newsletterEmail" value="Subscribe Now"/>
                            </div>
                        </div>
                        <!-- <div class="input-group mb-5">
        ...
        <div class="container">
            <div class="row">
                ...
                <p class="text-white f-size-12 rt-mb-0">Seller of Travel # 2107058 </p>
                    ...
                    <p class="rt-mt-15 f-size-14">Copyright © 2020.All Rights Reserved By <a href="index.php">Corporate Business Class</a></p>
                </div><!-- /.copy-text -->
                </div><!-- /.col-lg-6 -->
                <div class="col-lg-6 text-center text-lg-right">
                    <div class="rt-footer-social wow fade-in-bottom" data-wow-duration="1.5s">
                        <div>
                    <ul class="text-white text-md-left top-message f-size-12" style="display:block; float:right">
                            <li>Toll-free: (800) 753 0325</li>
                            <li>Local: (415) 354-9693</li>
                    </ul>
                </div>
