            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center rt-pt-70 rt-pb-60 rt-pl-70 rt-pr-20"
                        ...
                        <form id="resetPass" class="rt-form" data-parsley-validate>
                            <div class="row">
                                <div class="col-md-6 offset-3">

                                    <input type="password" name="password" class="form-control pill rt-mb-15"
                                        id="password" placeholder="New Password" required>
                                    <input type="password" name="con_password" class="form-control pill rt-mb-15"
                                        placeholder="Confirm New Password" data-parsley-equalto="#password" required>
