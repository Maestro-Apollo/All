            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center rt-pt-70 rt-pb-60 rt-pl-20 rt-pr-20"
                        ...
                        <h4 class="text-center"><strong>Recovery Code</strong></h4>
                        <p>Please check your email for recovery code</p>
                        ...
                        <form method="post" class="rt-form" data-parsley-validate>
                            <div class="row">
                                <div class="col-md-6 offset-md-3">
                                    ...
                                    <input type="number" name="code" class="form-control pill rt-mb-15"
                                        placeholder="Enter Code" data-parsley-minlength="6" data-parsley-maxlength="6"
                                        required>
                                    <input type="hidden" name="hash" class="form-control pill rt-mb-15"
                                        placeholder="Enter Code" value="<?php echo $_GET['hash']; ?>" required>
                                    <div class="text-center">
                                        <input type="submit"
                                            class="rt-btn rt-rounded rt-rounded-1 rt-Bshadow-1 btn-blue2" name="submit"
                                            value="Send">
                                    </div>
                                </div>
                            </div>
        ...
        $('#passRecover').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response == 2) {
                        toastr.success('Invalid Code!<br/>', '', {
                            showMethod: "fadeIn",
                            positionClass: 'toast-top-right',
                            timeOut: 5000,
                            allowHtml: true,
