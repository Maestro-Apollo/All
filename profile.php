            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center rt-pt-70 rt-pb-60 rt-pl-70 rt-pr-20"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="text-center"><strong><?php echo $row['username']; ?>'s Profile</strong></h4>
                            </div>
                        ...
                        <form id="myForm" class="rt-form" data-parsley-validate>
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="" class="text-left rt-mt-15">First Name</label>
                                    <input type="text" name="fname" class="form-control pill rt-mb-15"
                                        placeholder="First Name" value="<?php echo $row['fname']; ?>" required>
                                    <label for="" class="text-left rt-mt-15">Email Address</label>
                                    <input type="email" value="<?php echo $row['email']; ?>" name="email"
                                        class="form-control pill rt-mb-15" placeholder="Email Address" readonly
                                        required>


                                </div>
                                <div class="col-md-4">
                                    <label for="" class="text-left rt-mt-15">Last Name</label>
                                    <input type="text" value="<?php echo $row['lname']; ?>" name="lname"
                                        class="form-control pill rt-mb-15" placeholder="Last Name" required>
                                    <label for="" class="text-left rt-mt-15">Phone Number</label>
                                    <input type="text" value="<?php echo $row['phone']; ?>" name="phone"
                                        class="form-control pill rt-mb-15" placeholder="Phone Number" required>
                                    <!-- <label for="" class="text-left rt-mt-15">Flight preferences</label>
                                    <input type="text" value="<?php echo $row['flight']; ?>" name="flight"
                                        class="form-control pill rt-mb-15" placeholder="Flight preferences" required> -->

                                </div>
                                <div class="col-md-4">
                                    <span class="d-md-inline d-none getstarted-btn">
                                        <a href="index.php"
                                            class="rt-btn rt-rounded rt-rounded-1 rt-Bshadow-1 btn-blue1"
                                            style="color:#fff;">Book Your Flight!</a>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="" class="text-left rt-mt-15">TSA Number</label>
                                    <input type="text" name="tsa" class="form-control pill rt-mb-15"
                                        placeholder="TSA Number" value="<?php echo $row['tsa']; ?>">
                                    <label for="" class="text-left rt-mt-15">Global Entry</label>
                                    <input type="text" value="<?php echo $row['global']; ?>" name="global"
                                        class="form-control pill rt-mb-15" placeholder="Global Entry">
                                    <label for="" class="text-left rt-mt-15">Frequent Flyer Number (Airline)</label>
                                    <input type="text" value="<?php echo $row['airline']; ?>" name="airline"
                                        class="form-control pill rt-mb-15" placeholder="Airline">


                                </div>
                                <div class="col-md-4">
                                    <label for="" class="text-left rt-mt-15">Food Restrictions</label>
                                    <input type="text" value="<?php echo $row['food']; ?>" name="food"
                                        class="form-control pill rt-mb-15" placeholder="Food Restrictions">

                                    <label for="" class="text-left rt-mt-15">Seat preferences</label>
                                    <input type="text" value="<?php echo $row['seat']; ?>" name="seat"
                                        class="form-control pill rt-mb-15" placeholder="Seat preferences">
                                    <label for="" class="text-left rt-mt-15">Frequent Flyer Number (Number)</label>
                                    <input type="text" value="<?php echo $row['number']; ?>" name="number"
                                        class="form-control pill rt-mb-15" placeholder="Number">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <label for="" class="text-left ">Addition Information?</label>

                                    <textarea id="" cols="30" rows="5" name="flight" class="form-control  rt-mb-15"
                                        placeholder="Additional Information"><?php echo $row['flight']; ?></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-8 offset-md-2">
                                    <div class="text-center">
                                        <div class="d-flex">
                                            <input type="submit"
                                                class="rt-btn rt-rounded rt-rounded-1 rt-Bshadow-1 btn-blue2"
                                                value="Update">

                                            <a href="./reset-password.php"
                                                class="rt-btn rt-rounded rt-rounded-1 rt-ml-20 rt-Bshadow-1 btn-blue2">Reset
                                                Password</a>
                                        </div>
                                    </div>
                                </div>
