...
if(isset($_POST["newsletterWelcome"]))
{
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12 rt-mb-30 ">
                            ...
                            <div class="text-center col-md-12 rt-mb-30">
                                <input class="rt-btn rt-gradient pill rt-sm text-uppercase form-control btnHover" name="corporateForm" type="submit" value="Continue" style="padding: 14px;">
                            </div>
                        </div><!-- /.row -->
                    </form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 rt-mb-30">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="workTravel" id="inlineRadio2s" value="Yes">
                                        <label class="form-check-label" for="inlineRadio2s">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="workTravel" id="inlineRadio2ss" value="No" checked>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 rt-mb-30">
                                            <input type="text" class="form-control" name="CurrencyValue" placeholder="e.g. 2500 (total)">
                                        </div><!-- /.col-md-5 -->
                                        <div class="col-lg-5 rt-mb-30">
                                            <input type="text" class="form-control" name="Website" placeholder="e.g. link or website">
                                        </div><!-- /.col-md-5 -->
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 rt-mb-30">
                                        <label for="StopDuration">Max. Number of Stops</label>
                                ...
                                <div class="col-lg-12 rt-mb-30">
                                    ...
                                    <textarea class="form-control" name="Details" placeholder="Please answer the above questions and add any extra information"></textarea>
                                </div>
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-6 rt-mb-30">
                                            <label for="Name">Your Name</label>
                                            <input type="text" class="form-control rt-mt-10-n" name="YourName" placeholder="">
                                        </div><!-- /.col-md-6 -->
                                        <div class="col-lg-6 rt-mb-30">
                                            <label for="Email">Your Email</label>
                                            <input type="text" class="form-control rt-mt-10-n" name="YourEmail" placeholder="">
                                        </div><!-- /.col-md-6 -->
                                    </div>
                                </div>

                                <div class="text-center col-md-12 rt-mb-30">
                                    <input class="rt-btn rt-gradient pill rt-sm text-uppercase form-control btnHover" type="submit" name="personalForm" value="Create Your Trip Request">
                                </div>
                            </div><!-- /.row -->
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-7 mx-auto">
                        <div class="input-group mb-5">
                            <div class="w-100">
                                <input type="email" class="form-control text-white f-size-14" placeholder="Enter your email" aria-describedby="button-addon2" name="newsletter2">
                            </div>
                            <div class="input-group-append">
                                <input class="btn" type="submit" id="button-addon2" value="Subscribe Now" name="newsletterWelcome" />
                            </div>
                        </div><!-- end input gorup -->
                    </div><!-- /.col-lg-7 -->
                </div><!-- /.row -->
...
$(document).ready(function() {
   ...
   if(url[1] == "personal")
   {
    $('#btnPersonalClick').addClass('active');
