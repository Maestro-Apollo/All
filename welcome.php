...
<body>
    ...
    <section class="content-area mt-120 pos-rel welcome-section">
        <div class="testimonials-area">
            ...
            <div class="left-circle rt-shape-emenetns-1"
                style="background-image: url(assets/images/shape-elements/shape-4.png)"
                data-scrollax="properties: { translateY: '140px' }"></div><!-- /.rt-shape-emenetns-1 -->
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9 mx-auto col-lg-10">
                    <div class="flight-list-box rt-mb-30">
                        <div class="col-lg-12 rt-mb-30 rt-pt-30 rt-line-form flight-lable text-center">
                            <div class="tab">
                                <button class="tablinks rt-btn rt-rounded rt-rounded-1 rt-Bshadow-1 btn-grey1 active"
                                    onclick="openCity(event, 'corporate')">Corporate form</button>
                                <button class="tablinks rt-btn rt-rounded rt-rounded-1 rt-Bshadow-1 btn-grey1"
                                    id="btnPersonalClick" onclick="openCity(event, 'personal')">Personal form</button>
                            </div>
                        ...
                        <div class="rt-form rt-line-form flight-lable rt-pr-160 rt-pl-160 formDisplay" id="corporate">
                            <h6 class="text-333 rt-medium text-center">Please provide the following information to
                                discuss your needs with us or to start an instant trial.</h6>
                            <br>
                            <div class="row">
                                <div class="col-md-12 rt-mb-30 ">
                                    <label for="fst-name">Full Name</label>
                                    <input type="text" class="form-control" id="fst-name" name="FullName"
                                        placeholder="Enter Your Full Name ">
                                    <!-- <span class="text-danger"> <?php echo $nameErr; ?></span> -->
                                </div><!-- /.col-md-12 -->
                                <div class="col-md-12 rt-mb-30 ">
                                    <label for="work-email">Work Email</label>
                                    <input type="email" class="form-control" id="work-email" name="Email"
                                ...
                                <div class="col-md-12 rt-mb-30">
                                    ...
                                    <select id="travel-type" name="TravelType">
                                        ...
                                        <option value="complex">We also book many international, complex or group trips
                                        </option>
                                    </select>
                                    <!-- <span class="text-danger"> <?php echo $travelErr; ?></span> -->
                                </div><!-- /.col-md-12 -->
                                <div class="text-center col-md-12 rt-mb-30">
                                    <input class="rt-btn rt-gradient pill rt-sm text-uppercase form-control btnHover"
                                        name="corporateForm" id="corporateForm" type="submit" value="Continue">
                                </div>
                            </div><!-- /.row -->
                            <!-- </form> -->
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 rt-mb-30">
                                            ...
                                            <select id="miles" name="MilesPoints">
                                                ...
                                                <option value="I want to use my miles/points">I want to use my
                                                    miles/points</option>
                                                <option value="I want to reach an elite status goal">I want to reach an
                                                    elite status goal (advanced)</option>
                                            </select>
                                            <!-- <span class="text-danger"> <?php echo $roleErr; ?></span> -->
                                        </div><!-- /.col-md-12 -->
                                        <div class="col-lg-12 rt-mb-30">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="workTravel"
                                                    id="workTravel" value="Yes">
                                                <label class="form-check-label" for="inlineRadio2s">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="workTravel"
                                                    id="workTravels" value="No" checked>
                                    ...
                                    <p>What's the catch?</p>
                                        ...
                                        <div class="col-lg-12">
                                            <h4>Quote</h4>
                                            <label>Your best valid price for this trip (total for all
                                                travelers)?</label>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5 rt-mb-30">
                                                    <input type="text" class="form-control" name="CurrencyValue"
                                                        id="CurrencyValue" placeholder="e.g. 2500 (total)">
                                                </div><!-- /.col-md-5 -->
                                                <div class="col-lg-5 rt-mb-30">
                                                    <input type="text" class="form-control" name="Website" id="Website"
                                                        placeholder="e.g. link or website">
                                                </div><!-- /.col-md-5 -->
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12 rt-mb-30">
                                            ...
                                            <textarea class="form-control" name="Details" id="Details"
                                                placeholder="Please answer the above questions and add any extra information"></textarea>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="row">
                                                <div class="col-lg-6 rt-mb-30">
                                                    <label for="YourName">Your Name</label>
                                                    <input type="text" class="form-control rt-mt-10-n" id="YourName"
                                                        name="YourName" placeholder="">
                                                </div><!-- /.col-md-6 -->
                                                <div class="col-lg-6 rt-mb-30">
                                                    <label for="YourEmail">Your Email</label>
                                                    <input type="text" class="form-control rt-mt-10-n" id="YourEmail"
                                                        name="YourEmail" placeholder="">
                                                </div><!-- /.col-md-6 -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center col-md-12 rt-mb-30">
                                            <input
                                                class="rt-btn rt-gradient pill rt-sm text-uppercase form-control btnHover"
                                                type="button" id="personalForm" name="personalForm"
                                                value="Create Your Trip Request">
                                        </div>
                                    </div><!-- /.row -->
                                </div>
                                <div class="col-lg-4 border-lt">
                                    ...
                                    <div class="panel">
                                        ...
                                        <p>In aggregate, the TravelEagle experts live on six continents and have visited more than 140 countries. They run secret travel forums, subscribe to all airline newsletters, and can recite airport codes like the alphabet.</p>
                                            ...
                                            <div class="panel">
                                                <p>Our experts help you save time and money by applying their deep
                                                    technical expertise and many years of experience to the best search
                                                    algorithms on the planet. They also have many contacts at airlines,
                                                    hotels and deal brokers.</p>
                                                <p>More than just experience, our experts work together to systemize
                                                    their strategies so they can apply them to your travel plans and
                                                    itineraries. They can search hundred of deal sources and try many
                                                    tricks in very little time.</p>
                                            </div>
                                            <p class="accordion">What if I don't save?</p>
                                            <div class="panel">
                                                <p>If you provide a quote, you don't pay if you don't save; it's as
                                                    simple as that and there's no funny business. We highly recommend
                                                    providing a quote so you get our savings guarantee.</p>
                                                <p>As you configure your trip on this page, we show you our guarantee
                                                    and the simple terms. We have worded these terms as simply as
                                                    possible, so you can rely on them without fine print.</p>
                                            </div>
                                            <p class="accordion">Why does it work?</p>
                                            <div class="panel">
                                                <p>TravelEagle produces great results for one main reason: our experts
                                                    are more obsessed with flights, hotels and loyalty programs than
                                                    anyone else on the planet. They've also hand-built many thousands of
                                                    complex itineraries.</p>
                                                <p>We've made this work for you with a business model that makes sense.
                                                    We aren't dependent on commissions like travel agents, so we are
                                                    100% on your side and only charge our fee if we beat your quote by
                                                    more than our fee.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-12 rt-mb-30 border-bt">
                                            <p class="f-size-13">You will <span class="text-danger">NOT</span> be
                                                charged upfront. Only once we are sure we can meet our guarantee.</p>
                                        </div>
                                        <!-- <div class="col-md-12 rt-mb-30">
                            ...
                            <div class="input-group mb-5">
                                <div class="w-100">
                                    <input type="email" class="form-control text-white f-size-14"
                                        placeholder="Enter your email" aria-describedby="button-addon2"
                                        name="newsletter2" id="newsletter2">
                                </div>
                                <div class="input-group-append">
                                    <input class="btn" type="submit" id="newsletterWelcome" value="Subscribe Now"
                                                    ...
                                                    if (Website != null && Website != "") {
                                                        if (NoofStop != null && NoofStop != "") {
                                                            if (StopDuration != null && StopDuration !=
                                                                ...
                                                                toastr.success(
                                                                    'Please enter Max. Duration of Stops <br/>',
                                                                    '', {
                                                                        showMethod: "fadeIn",
                                                                        positionClass: 'toast-top-right',
                                                                        timeOut: 5000,
                                                            ...
                                                            toastr.success(
                                                                'Please enter Max. Number of Stops <br/>',
                                                                '', {
                                                                    showMethod: "fadeIn",
                                                                    positionClass: 'toast-top-right',
                                                                    timeOut: 5000,
