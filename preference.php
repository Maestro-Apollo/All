            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center rt-pt-70 rt-pb-60 rt-pl-70 rt-pr-20"
                        ...
                        <h4 class="text-left"><strong><?php echo $row['username']; ?>'s Preference</strong></h4>
                        <form id="myForm" class="rt-form" data-parsley-validate>
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="submit" class="rt-btn rt-rounded rt-rounded-1 rt-Bshadow-1 btn-blue2"
                                        value="Update">
                            ...
                            <!-- <h5 class="text-left font-weight-bold">Frequent Flyer Number</h5> -->
                    ...
                    <div class="row">
                        <div class="col-lg-7 mx-auto">
                            <div class="input-group mb-5">
                                <div class="w-100">
                                    <input type="email" class="form-control text-white f-size-14" name="newsletter1"
                                        id="newsletter1" placeholder="Enter your email">
                                </div>
                                <!-- <span class="text-danger"> <?php echo $newsletterErr; ?></span> -->
                                <div class="input-group-append">
                                    <input class="btn" type="button" name="newsletterIndex" id="newsletterEmail"
                                        value="Subscribe Now" />
                                </div>
                            </div>
                            <!-- <div class="input-group mb-5">
