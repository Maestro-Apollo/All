...
jQuery(document).ready(function ($) {
  ...
  $('.open-creatac').on("click", function () {
    ...
    $(".rt-modal-input.one, .rt-modal-headr.one").removeClass("show-cac");
    $(".rt-modal-input.one, .rt-modal-headr.one").addClass("hide-cac");
  });
  $('.open-loginac').on("click", function () {
    $(".rt-modal-input.one, .rt-modal-headr.one").removeClass("hide-cac");
    $(".rt-modal-input.one, .rt-modal-headr.one").addClass("show-cac");
    $(".rt-modal-input.two , .rt-modal-headr.two").addClass("hide-cac");
    $(".rt-modal-input.two , .rt-modal-headr.two").removeClass("show-cac");
  });
